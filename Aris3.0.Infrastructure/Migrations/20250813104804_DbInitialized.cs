    ...
    public partial class DbInitialized : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), true, "Hanoi", "Vn", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "admin@gmail.com", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "Admin Person", "0123456789", "Sea", "Admin", "HN", "100000" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), true, "HCMC", "Vn", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "user1@gmail.com", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "User One", "0987654321", "Sea", "User", "HCM", "700000" },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), true, "Danang", "Vn", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "user2@gmail.com", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "User Two", "0911222333", "Sea", "User", "DN", "550000" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "Access to standard features and content.", "Basic Plan", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "Basic" },
                    { 2, new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "Includes HD streaming and exclusive content.", "Premium Plan", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "Premium" },
                    { 3, new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "For organizations with extended access and multiple accounts.", "Enterprise Plan", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "Enterprise" }
                });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "AccountStat", "Created", "Email", "LastUpdated", "Password", "PersonId", "Role", "SubcriptionId", "UserName", "status" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), true, new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "admin@gmail.com", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "admin123", new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "Admin", 1, "admin", true },
                    { new Guid("22222222-2222-2222-2222-222222222222"), true, new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "user1@gmail.com", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "user123", new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "User", 2, "user1", true },
                    { new Guid("33333333-3333-3333-3333-333333333333"), true, new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "user2@gmail.com", new DateTime(2025, 8, 13, 10, 48, 3, 776, DateTimeKind.Utc).AddTicks(1338), "user123", new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), "User", 3, "user2", true }
                });
